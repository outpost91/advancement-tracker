 ...
 */
exports.getAuthenticatedUser = (req, auth) => {
    return new Promise((resolve, reject) => {
        if ((!req.headers.authorization || !req.headers.authorization.startsWith('Bearer '))
            && (!req.cookies.__session)) {
            reject(new ReferenceError('No Firebase ID token was passed as a Bearer token in the Authorization header.'.concat('Make sure you authorize your request by providing the following HTTP header:', 'Authorization: Bearer <Firebase ID Token>', 'or by passing a "__session" cookie.')));
        }
...
*/
exports.isUserAccessible = (req, database) => {
