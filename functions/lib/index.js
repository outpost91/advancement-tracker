...
*/
exports.updateBreezeAttendance = functions.database.ref('/lessons/{lessonID}/attendance').onWrite((change, context) => {
...
*/
exports.updateNewUser = functions.auth.user().onCreate(user => {
    //Check Breeze User
...
exports.cleanUpRemovedUser = functions.auth.user().onDelete(user => {
