...
import * as breeze_key from './breeze-key.json';
 ...
 */
export const getPeople = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_people", req.query || req.body), res)

export const getEvents = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_events", req.query || req.body), res)

export const getEvent = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_event", req.query || req.body), res)

export const getCalendars = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_calendars", req.query || req.body), res)

export const getEligible = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_event_eligible", req.query || req.body), res)

export const getTags = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_tags", req.query || req.body), res)

export const getFolders = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("get_folders", req.query || req.body), res)

export const updateEventCheckIn = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("event_check_in", req.query || req.body), res)

export const updateEventCheckOut = (req, res) => _APIHandler(_genericAPIFunctionCallWrapper("event_check_out", req.query || req.body), res)
 ...
 * Event checkin
 */
export const updateCheckIn = req => {
 ...
 * Event checkout
 */
export const updateCheckOut = req => {
